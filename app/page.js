...
// // import heroImage from '../public/images/hero-image.jpg'; // Replace with your actual image path

// export default function Home() {
//   return (
//     <>
//       <Head>
//         <title>AskC - Your Chatting Hub</title>
...
//             <h1 className="text-5xl font-bold mb-4 text-white">Welcome to AskC</h1>
//             <p className="text-lg mb-8 text-white">
//               Connect with friends, family, and colleagues effortlessly. Experience seamless communication with AskC.
//             </p>
//             <Link href= '/forums' className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded">
//               Start Chatting
//             </Link>
//           </section>
...
//   <div className="bg-gray-100 p-6 rounded-lg hover:bg-blue-700">
//     <h3 className="text-xl font-semibold mb-2 hover:text-gray-100">Connect with Your Community</h3>
//     <p className='hover:text-gray-100'>AskC connects you with people in your community who share your interests and background.  Find support, share experiences, and build meaningful connections.</p>
//   </div>
//   <div className="bg-gray-100 p-6 rounded-lg hover:bg-blue-700">
//     <h3 className="text-xl font-semibold mb-2 hover:text-gray-100">Dedicated Community Spaces</h3>
//     <p className='hover:text-gray-100'>Join dedicated chat rooms for your specific community.  Discuss local news, share recommendations, organize events, and stay connected with what matters most to you.</p>
//   </div>
//   <div className="bg-gray-100 p-6 rounded-lg hover:bg-blue-700">
//     <h3 className="text-xl font-semibold mb-2 hover:text-gray-100">Easy and Private Chatting</h3>
//     <p className='hover:text-gray-100'>Enjoy a seamless and private chatting experience.  AskC makes it easy to start conversations, share photos, and stay in touch with your community members.</p>
//   </div>
//     <div className="bg-gray-100 p-6 rounded-lg hover:bg-blue-700">
//     <h3 className="text-xl font-semibold mb-2 hover:text-gray-100">Find Local Support</h3>
//     <p className='hover:text-gray-100'>Need help with something? Connect with neighbors and community members who can offer assistance, advice, or resources. AskC is a place to find support and give back to your community.</p>
//   </div>
//   <div className="bg-gray-100 p-6 rounded-lg hover:bg-blue-700">
//     <h3 className="text-xl font-semibold mb-2 hover:text-gray-100">Stay Informed</h3>
//     <p className='hover:text-gray-100'>Stay up-to-date on local news, events, and happenings within your community. AskC helps you stay informed and connected to what's going on around you.</p>
//   </div>
//   <div className="bg-gray-100 p-6 rounded-lg hover:bg-blue-700">
//     <h3 className="text-xl font-semibold mb-2 hover:text-gray-100">Build Stronger Community Bonds</h3>
//     <p className='hover:text-gray-100'>AskC is designed to foster stronger community bonds.  By connecting you with like-minded individuals, we help you build relationships and create a more supportive and connected community.</p>
//   </div>
// </section>
...
//   title: 'Home- AskC',
//   description: 'A platform that help you to connect with people of your choice.',
// }
      ...
      <div className="h-screen w-screen overflow-hidden bg-black">
        <div className="mx-auto mt-32 w-screen max-w-2xl">
          <div className="text-center text-3xl text-white">
            <h1 className="text-indigo-200 text-10xl font-extrabold">Welcome To AskC</h1>

            <br />

            <p className='text-2xl'>Connect with friends, family, and colleagues effortlessly. Experience seamless communication with AskC.</p>
          </div>
