...
const topics = [
  { title: 'Python', image: '/images/python.png', desc: 'Python is a programming language that lets you work quickly and integrate systems more effectively.', slug: 'Python-new' },
  { title: 'JavaScript', image: '/images/javascript.webp', desc: 'JavaScript is the programming language of the web. It powers interactive features on websites and is essential for front-end development.', slug: 'Javascript-new' },
  { title: 'Java', image: '/images/java.png', desc: 'Java is a versatile and robust programming language widely used for developing enterprise applications, Android apps, and more.', slug: 'Java-new' },
  { title: 'C++', image: '/images/c++.png', desc: 'C++ is a powerful, high-performance language often used for game development, system programming, and high-performance computing.', slug: 'Cpp-new' },
  { title: 'Go', image: '/images/Go.png', desc: 'Go is a modern, open-source language designed for efficiency and simplicity, often used for building scalable and concurrent systems.', slug: 'Go-new' },
  { title: 'Ruby', image: '/images/ruby.png', desc: 'Ruby is a dynamic, object-oriented language known for its elegance and developer happiness, often used for web development (Ruby on Rails).', slug: 'Ruby-new' }
];

const ForumsPage = () => {
  return (
    <div className="container mx-auto my-16 px-4">
      <h1 className="text-3xl md:text-4xl font-bold text-center text-black mb-10">Forums</h1>

      <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {topics.map((topic) => (
          <div
            key={topic.slug}
            className="bg-slate-100 rounded-lg shadow hover:shadow-md transition duration-300 flex flex-col items-center text-center p-5"
          >
            <Image
            ...
            <Link href={`/forum/${topic.slug}`} passHref>
              <Button className="px-4 py-2 border border-slate-500">Discuss Now</Button>
            </Link>
          </div>
        ))}
      </div>
